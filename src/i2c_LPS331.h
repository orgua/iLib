...
public:
    ...
    inline void setDatarate(const uint8_t freqHz)
    {
        ...
        i2c.setRegister(
                I2C_ADDRESS, CTRL_REG1, B01110000,
                _value); // chip active, 12.5Hz, no INT, continuous update, no delta_pressure, SPI/I2C
    };
    ...
    inline uint8_t initialize(void) { return initialize(25); };
    ...
    inline void    triggerMeasurement(void) { i2c.setRegister(I2C_ADDRESS, CTRL_REG2, 0x01, 0x01); }
    ...
    */
    ...
    {
        static const long xnode[8] = {2867200, 3101257, 3335314, 3569371,
                                      3803429, 4037486, 4271543, 4505600};
