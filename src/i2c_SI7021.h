...
CONSUMPTION: sleep 0.6�A, measure 120-180�A, 3.1mA Heater
...
private:
    ...
    static const uint8_t CMD_MEASURE_HUMIDITY_NO_HOLD =
            (0xF5); // No Hold: Not Acknowledging read requests
...
public:
    ...
    /**< softwarereset */
    inline void    reset(void) { i2c.writeCMD(I2C_ADDRESS, CMD_RESET); };
    ...
    void           triggerMeasurement() { i2c.writeCMD(I2C_ADDRESS, CMD_MEASURE_HUMIDITY_HOLD); };
    ...
    /**< standardcall */
    inline void getMeasurement(float &rh) { getHumidity(rh); }
    ...
    /**< not very useful */
    void  requestTemperature() { i2c.writeCMD(I2C_ADDRESS, CMD_MEASURE_TEMPERATURE_HOLD); };
