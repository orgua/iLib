...
private:
    ...
    { return (2.4 * (256 - atime)); }; // TODO: WB
    inline uint8_t static const MSEC_TO_ATIME(const uint16_t msec) { return (256 - (msec / 2.4)); };
    inline uint8_t static const FACT_TO_ATIME(const uint8_t factor)
    { return (256 - factor); }; // TODO: WB
    inline uint8_t MSEC_TO_ATIMELONG(const uint16_t msec)
    { return (256 - (msec / 28.8)); }; // TODO: WB
