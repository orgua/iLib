...
public:
    ...
    inline void setTime(const uint16_t YYYY, const uint8_t MM, const uint8_t W, const uint8_t DD,
                        const uint8_t hh, const uint8_t mm, const uint8_t ss)
    {
    ...
    inline void readTime()
    {
        ...
        {
            datetime[counter] =
                    uint8_t(((datetime[counter] >> 4) * 10) + (datetime[counter] & B00001111));
            //counter++;
        }
    };
    ...
    inline void getSeconds(uint8_t &unit) { unit = datetime[0]; };

    inline void setMinutes(const uint8_t unit = 0) {
        // TODO:
    };

    inline void getMinutes(uint8_t &unit) { unit = datetime[1]; };

    inline void setHours(const uint8_t unit = 0) {
        // TODO
    };

    inline void getHours(uint8_t &unit) { unit = datetime[2]; };

    inline void setDays(const uint8_t unit = 0) {
        // TODO
    };

    inline void getDays(uint8_t &unit) { unit = datetime[3]; }

    inline void setWeekdays(const uint8_t unit = 0) {};

    inline void getWeekdays(uint8_t &unit) { unit = datetime[4]; };

    inline void setMonth(const uint8_t unit = 0) {
        // TODO:
    };

    inline void getMonth(uint8_t &unit) { unit = datetime[5]; };

    inline void setYears(const uint8_t unit = 0) {
        // TODO
    };

    inline void getYears(uint16_t &unit) { unit = VAL_YEAR_OFFSET + uint16_t(datetime[6]); };
    /*
    TODO:
