...
Driver for the MAG3310-Sensor
 ...
 CONSUMPTION: standby 2 �A, measure 9-900 �A

 Details: up to 80Hz, �1000 �T, Sensitivity of 0.10 �T
...
public:
    ...
    inline void reset(void) { i2c.setRegister(I2C_ADDRESS, REG_CTRL_REG2, MASK_RESET, 255); };
    ...
    inline void setDataRate(const uint8_t hz = 10)
    {
        ...
        i2c.setRegister(I2C_ADDRESS, REG_CTRL_REG1, (MASK_DR | MASK_OSR),
                        _value << 3); // set combination of data rate and oversampling
    }

    inline uint8_t initialize(void) { return initialize(100); };
