...
private:
    ...
    WirePlus &
    operator=(const WirePlus &); // declaration only for copy assignment --> make it uncopyable
};
...
uint8_t WirePlus::probeAddress(const uint8_t address) { return probe(address); };

void    WirePlus::write(const uint8_t address, const uint8_t register_address,
                        const uint8_t write_value[], const uint8_t length = 1)
{
    if (!length) return;
    Wire.beginTransmission(address);
...
void WirePlus::writeByte(const uint8_t address, const uint8_t register_address,
...
void WirePlus::read(const uint8_t address, const uint8_t register_address, uint8_t buffer[],
...
void WirePlus::setRegister(const uint8_t address, const uint8_t register_address,
                           const uint8_t mask, const uint8_t write_value)
{
    uint8_t _setting;
...
uint8_t WirePlus::getRegister(const uint8_t address, const uint8_t register_address,
                              const uint8_t mask)
{
    uint8_t _setting;
